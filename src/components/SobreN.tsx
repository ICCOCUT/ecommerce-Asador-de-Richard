...
/**
 * La función Contacto devuelve un componente JSX que muestra información sobre la misión, visión,
 * historia, equipo y fundador de Asador de Richard.
 * @returns Un componente funcional de React que presenta una sección sobre la misión, visión,
 * historia, equipo y fundador de una empresa llamada "Asador de Richard". El componente utiliza el
 * componente de imagen Next.js para mostrar imágenes y mapas sobre matrices para mostrar contenido de
 * texto.
 */
