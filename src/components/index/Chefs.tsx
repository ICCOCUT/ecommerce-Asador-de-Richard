					...
					<div className='grid lg:grid-cols-3 gap-x-6 lg:gap-x-12'>
						<div
							...
							<div className='relative overflow-hidden bg-no-repeat bg-cover'>
								...
								/>
								<section>
									<div className='absolute top-0 right-0 bg-yellow-600 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed opacity-0 hover:opacity-50 transition duration-300 ease-in-out'></div>
								</section>
								<svg
						...
						<div className='bg-yellow-600 block rounded-lg shadow-lg mb-6 lg:mb-0'>
							<div
								...
								/>
								<section>
									<div className='absolute top-0 bg-yellow-600 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed opacity-0 hover:opacity-50 transition duration-300 ease-in-out'></div>
								</section>
								<svg
									className='absolute left-0 bottom-0'
									xmlns='http://www.w3.org/2000/svg'
