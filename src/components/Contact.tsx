								...
								<div className='flex flex-wrap'>
									<div className='mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6'>
										<div className='flex items-start'>
											<div className='shrink-0'>
												<div className='p-4 bg-primaryYellow rounded-md shadow-md w-14 h-14 flex items-center justify-center'>
													<svg
														aria-hidden='true'
														focusable='false'
														data-prefix='fas'
											...
											<div className='grow ml-6'>
												...
												<p className='text-gray-500'>+52 33 2038 0734</p>
											</div>
										</div>
									</div>
									<div className='mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6'>
										<div className='flex items-start'>
											...
											<div className='grow ml-6'>
												<p className='font-bold mb-1'>Preguntas sobre ventas</p>
												<p className='text-gray-500'>Ventas@example.com</p>
												<p className='text-gray-500'>+52 33 2038 0734</p>
											</div>
										</div>
									</div>
									<div className='mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6'>
										<div className='flex align-start'>
											...
											<div className='grow ml-6'>
												<p className='font-bold mb-1'>Prensa</p>
												<p className='text-gray-500'>Prensa@example.com</p>
												<p className='text-gray-500'>+52 33 2038 0734</p>
											</div>
										</div>
									</div>
									<div className='grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6'>
										<div className='flex align-start'>
											...
											<div className='grow ml-6'>
												<p className='font-bold mb-1'>Reporte de Bugs</p>
